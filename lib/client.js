window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"balance.price.table.hit": "命中",
			"balance.price.table.miss": "未命中",
		...
		const en = {
			...
			"balance.price.table.hit": "Hit",
			"balance.price.table.miss": "Miss",
		...
		const css = ""
			...
			+ ".dsbSection{padding:10px 0;border-top:1px solid var(--dsw-alias-border-l1,rgba(255,255,255,.06))}.dsbSection:first-child{border-top:none}"
			...
			+ ".dsbPriceTable th{color:var(--dsw-alias-label-tertiary);font-weight:600;text-align:left;padding:3px 6px;white-space:nowrap;border-bottom:1px solid var(--dsw-alias-border-l1,rgba(255,255,255,.08))}"
			+ ".dsbPriceTable td{padding:3px 6px;vertical-align:top;border-bottom:1px solid var(--dsw-alias-border-l1,rgba(255,255,255,.04))}"
			+ ".dsbPriceTable .dsbPriceModel{color:var(--dsw-alias-label-tertiary);white-space:nowrap}"
		...
		const costStore = (() => {
			...
			return {
				...
				noteMessage(sessionId, accountKey, turnStartTime, usage, selection, pricing, turnId, step) {
					...
					// 月度费用不受「本次打开」限制：当月内消息哪怕是翻旧会话翻出来的也要计。
		...
		function BalanceDetailsPanel({ t, store }) {
			...
			return react_jsx_runtime.jsxs("div", { ref: rootRef, className: "dsbPanel" + (open ? " dsbOpen" : ""), children: [
				...
				react_jsx_runtime.jsxs("div", { className: "dsbPanelBody", children: [
					...
					react_jsx_runtime.jsxs("div", { className: "dsbSection", children: [
						react_jsx_runtime.jsx("div", { className: "dsbSectionTitle", children: t("balance.monthly.title") }),
						react_jsx_runtime.jsx("div", { className: "dsbRow", children: react_jsx_runtime.jsx("span", { className: "dsbRowValue", children: formatMonthlyCost(cost, pricing?.currency ?? null) }) })
					] }),
					react_jsx_runtime.jsxs("div", { className: "dsbSection", children: [
